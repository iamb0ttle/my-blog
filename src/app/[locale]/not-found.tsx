...
export default function LocaleNotFound() {
  ...
  useEffect(() => {
    // Extract locale from pathname (e.g., /ko/something -> 'ko', /en/something -> 'en')
    const segments = pathname.split('/')
    const pathLocale = segments[1] // First segment after the initial slash
  ...
  const content = {
    ko: {
      ...
      metaTitle: '페이지를 찾을 수 없습니다 - B(H)log',
    ...
    en: {
      ...
      metaTitle: 'Page Not Found - B(H)log',
